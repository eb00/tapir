...
static char const rcsid[] =
  "$Id: hybrid_core.c,v 1.6 2004/11/15 20:41:36 marc Exp $";
...
struct str_Hybrid *
new__NTID (struct str1 (*f1) (int, int, int, int), int i11, int j11, int i21,
           int j21)
{
  struct str__NTID *t;
...
struct str_Hybrid *
new_Ult (int a1, int a2, struct str1 (*f3) (int, int, int, int), int i13,
         int j13, int i23, int j23)
{
  struct str_Ult *t;
...
struct str_Hybrid *
new_Ulb (int a1, int a2, struct str1 (*f3) (int, int, int, int), int i13,
         int j13, int i23, int j23)
{
  struct str_Ulb *t;
...
struct str_Hybrid *
new_Eds (int a1, int a2, struct str1 (*f3) (int, int, int, int), int i13,
         int j13, int i23, int j23)
{
  struct str_Eds *t;
...
struct str_Hybrid *
new_Edt (int a1, int a2, struct str1 (*f3) (int, int, int, int), int i13,
         int j13, int i23, int j23)
{
  struct str_Edt *t;
...
struct str_Hybrid *
new_Edb (int a1, int a2, struct str1 (*f3) (int, int, int, int), int i13,
         int j13, int i23, int j23)
{
  struct str_Edb *t;
...
struct str_Hybrid *
new_Sr (int a1, int a2, struct str1 (*f3) (int, int, int, int), int i13,
        int j13, int i23, int j23)
{
  struct str_Sr *t;
...
struct str_Hybrid *
new_Bt (int a1, int a2, int a3, int a4, int a5,
        struct str1 (*f6) (int, int, int, int), int i16, int j16, int i26,
        int j26)
{
  struct str_Bt *t;
...
struct str_Hybrid *
new_Bb (int a1, int a2, int a3, int a4, int a5,
        struct str1 (*f6) (int, int, int, int), int i16, int j16, int i26,
        int j26)
{
  struct str_Bb *t;
...
struct str_Hybrid *
new_Il (int a1, int a2, int a3, int a4, int a5, int a6,
        struct str1 (*f7) (int, int, int, int), int i17, int j17, int i27,
        int j27)
{
  struct str_Il *t;
...
struct str_Hybrid *
new_El (int a1, int a2, int a3, int a4, int a5, int a6)
{
  struct str_El *t;
...
struct str_Hybrid *
new_Nil (int a1, int a2, int a3, int a4)
{
  struct str_Nil *t;
...
char *
asym1 (char *t, int l, int r, int u, int v)
{
  int k, ln;
  ln = max ((v - u) - (r - l), 0);
  for (k = 0; k <= ln - 1; k++)
...
char *
asym2 (char *t, int l, int r, int u, int v)
{
  int k, ln;
  ln = max ((r - l) - (v - u), 0);
  for (k = 0; k <= ln - 1; k++)
...
pp_str_Hybrid (struct str1 l)
{
  ...
  else if (c->utype == SIGID_Ult) {
/* 	   gx++; */
    pp_str_Hybrid (((struct str_Ult *) (c->entry))->a3);
  }
  else if (c->utype == SIGID_Ulb) {
    r1 = one_space (r1);
    r2 = one_space (r2);
    r3 = one_space (r3);
...
void
free_str_Hybrid (struct str_Hybrid *c)
{
  struct str1 l, l2;
...
struct str1
build_str_Hybrid (struct str1 cl)
{
  struct str1 l;
  struct str_Hybrid *c;
  ...
  c = cl.alg_enum;
  if (c->utype == SIGID__NTID) {
    ((struct str__NTID *) (c->entry))->a1 =
      (*((struct str__NTID *) (c->entry))->
       f1) (((struct str__NTID *) (c->entry))->i11,
            ((struct str__NTID *) (c->entry))->j11,
            ((struct str__NTID *) (c->entry))->i21,
            ((struct str__NTID *) (c->entry))->j21);
  }
  else if (c->utype == SIGID_Ult) {
    ((struct str_Ult *) (c->entry))->a3 =
      (*((struct str_Ult *) (c->entry))->
       f3) (((struct str_Ult *) (c->entry))->i13,
            ((struct str_Ult *) (c->entry))->j13,
            ((struct str_Ult *) (c->entry))->i23,
            ((struct str_Ult *) (c->entry))->j23);
  }
  else if (c->utype == SIGID_Ulb) {
    ((struct str_Ulb *) (c->entry))->a3 =
      (*((struct str_Ulb *) (c->entry))->
       f3) (((struct str_Ulb *) (c->entry))->i13,
            ((struct str_Ulb *) (c->entry))->j13,
            ((struct str_Ulb *) (c->entry))->i23,
            ((struct str_Ulb *) (c->entry))->j23);
  }
  else if (c->utype == SIGID_Eds) {
    ((struct str_Eds *) (c->entry))->a3 =
      (*((struct str_Eds *) (c->entry))->
       f3) (((struct str_Eds *) (c->entry))->i13,
            ((struct str_Eds *) (c->entry))->j13,
            ((struct str_Eds *) (c->entry))->i23,
            ((struct str_Eds *) (c->entry))->j23);
  }
  else if (c->utype == SIGID_Edt) {
    ((struct str_Edt *) (c->entry))->a3 =
      (*((struct str_Edt *) (c->entry))->
       f3) (((struct str_Edt *) (c->entry))->i13,
            ((struct str_Edt *) (c->entry))->j13,
            ((struct str_Edt *) (c->entry))->i23,
            ((struct str_Edt *) (c->entry))->j23);
  }
  else if (c->utype == SIGID_Edb) {
    ((struct str_Edb *) (c->entry))->a3 =
      (*((struct str_Edb *) (c->entry))->
       f3) (((struct str_Edb *) (c->entry))->i13,
            ((struct str_Edb *) (c->entry))->j13,
            ((struct str_Edb *) (c->entry))->i23,
            ((struct str_Edb *) (c->entry))->j23);
  }
  else if (c->utype == SIGID_Sr) {
    ((struct str_Sr *) (c->entry))->a3 =
      (*((struct str_Sr *) (c->entry))->
       f3) (((struct str_Sr *) (c->entry))->i13,
            ((struct str_Sr *) (c->entry))->j13,
            ((struct str_Sr *) (c->entry))->i23,
            ((struct str_Sr *) (c->entry))->j23);
  }
  else if (c->utype == SIGID_Bt) {
    ((struct str_Bt *) (c->entry))->a6 =
      (*((struct str_Bt *) (c->entry))->
       f6) (((struct str_Bt *) (c->entry))->i16,
            ((struct str_Bt *) (c->entry))->j16,
            ((struct str_Bt *) (c->entry))->i26,
            ((struct str_Bt *) (c->entry))->j26);
  }
  else if (c->utype == SIGID_Bb) {
    ((struct str_Bb *) (c->entry))->a6 =
      (*((struct str_Bb *) (c->entry))->
       f6) (((struct str_Bb *) (c->entry))->i16,
            ((struct str_Bb *) (c->entry))->j16,
            ((struct str_Bb *) (c->entry))->i26,
            ((struct str_Bb *) (c->entry))->j26);
  }
  else if (c->utype == SIGID_Il) {
    ((struct str_Il *) (c->entry))->a7 =
      (*((struct str_Il *) (c->entry))->
       f7) (((struct str_Il *) (c->entry))->i17,
            ((struct str_Il *) (c->entry))->j17,
            ((struct str_Il *) (c->entry))->i27,
            ((struct str_Il *) (c->entry))->j27);
  }
  else if (c->utype == SIGID_El) {
  }
  else if (c->utype == SIGID_Nil) {
...
double
calc_hybrid (int i1, int j1, int i2, int j2)
{
...
void
calc_unpaired_left_top (int i1, int j1, int i2, int j2)
{
  double v1, v2, v3;
...
void
calc_unpaired_left_bot (int i1, int j1, int i2, int j2)
{
  ...
  if (((j1 - i1) >= 2) && ((j2 - i2) >= 2) && compl (x[i1 + 2], y[i2 + 2])
      && ((i2 < helix_start) || (i2 >= helix_end))) {
    v2 =
      (tbl_closed[i1 + 1][i2 + 1] +
       dl_energy ((i1 + 1) + 1, (i2 + 1) + 1)) + dr_energy ((i1 + 1) + 1,
                                                            (i2 + 1) + 1);
    /* No iteration neccessary! */
  }
  else {
  ...
  if (((j1 - i1) >= 1) && ((j2 - i2) >= 2) && compl (x[i1 + 1], y[i2 + 2])
      && ((i2 < helix_start) || (i2 >= helix_end))) {
...
void
calc_closed (int i1, int j1, int i2, int j2)
{
  double v1, v2, v3, v4, v5, v6, v7, v7b, v7c, v7d, v7e, v7f, v7g, v8, v9,
    v10, v11, v12;
  int k;
  int k2;
  int k3;
  ...
  if (((j1 - i1) >= 3) && ((j2 - i2) >= 2) && compl (x[i1 + 1], y[i2 + 1])
      && ((i2 < helix_start) || (i2 >= helix_end - 1))) {
    v3 = 65000;
  ...
  if (((j1 - i1) >= 3) && ((j2 - i2) >= 3) && compl (x[i1 + 1], y[i2 + 1])) {
    ...
    for (k3 = i1 + 2;
         k3 <= min (i1 + min (3, iloop_upper_limit + 1), j1 - 1); k3++) {
      if (x[k3] == X)
        break;
      for (k4 = i2 + 2;
           k4 <= min (i2 + min (3, iloop_upper_limit + 1), j2 - 1); k4++) {
        if ((k4 > helix_start) && (i2 < helix_end - 1))
          break;
        if (compl (x[k3 + 1], y[k4 + 1])) {
          v6 =
            do_il_special (i1 + 1, i2 + 1, i1 + 1, k3, i2 + 1, k4,
                           tbl_closed[k3][k4]);
          /* No iteration neccessary! */
          v7 = v6 < v7 ? v6 : v7;
        }
    ...
    if ((x[k3] != X)) {         /*  && !((k4 > helix_start) && (i2 < helix_end-1))) { */
      ...
      for (k3 = i1 + 2; k3 <= min (i1 + 3, j1 - 1); k3++) {
        if (x[k3] == X)
          break;
        for (k4 = i2 + 4;
             k4 <= min (i2 + iloop_upper_limit + 1, j2 - 1); k4++) {
          if ((k4 > helix_start) && (i2 < helix_end - 1))
            break;
          if (compl (x[k3 + 1], y[k4 + 1])) {
            v6 =
              do_il (i1 + 1, i2 + 1, i1 + 1, k3, i2 + 1, k4,
                     tbl_closed[k3][k4]);
            /* No iteration neccessary! */
            v7b = v6 < v7b ? v6 : v7b;
          }
      ...
      if ((x[k3] != X)) {       /*  && !((k4 > helix_start) && (i2 < helix_end-1))) { */
        for (k3 = i1 + 4;
             k3 <= min (i1 + iloop_upper_limit + 1, j1 - 1); k3++) {
          if (x[k3] == X)
            break;
  ...
  if (((j1 - i1) >= 1) && ((j2 - i2) >= 1)
      && (j1 == i1 + 1 || x[i1 + 2] != 'X') && ((i2 >= helix_end - 1)
                                                || (helix_end > j2))) {
    if (compl (x[i1 + 1], y[i2 + 1])) {
      v8 =
        ((((j1) - (i1 + 1)) > 0) ? dli_energy (i1 + 1,
                                               i2 + 1) : 0) + ((((j2) -
                                                                 (i2 +
                                                                  1)) >
                                                                0) ?
...
struct str1
back_hybrid (int i1, int j1, int i2, int j2)
{
...
struct str1
back_unpaired_left_bot (int i1, int j1, int i2, int j2)
{
  ...
  if (((j1 - i1) >= 1) && ((j2 - i2) >= 2)
    ...
    v1.alg_enum =
      new_Ulb (i1, i2 + 1, back_unpaired_left_bot, i1, j1, i2 + 1, j2);
    /* No iteration neccessary! */
  }
  else {
    v1.alg_mfe = 65000;
    ...
    v2.alg_mfe =
      (tbl_closed[i1 + 1][i2 + 1] +
       dl_energy ((i1 + 1) + 1, (i2 + 1) + 1)) + dr_energy ((i1 + 1) + 1,
                                                            (i2 + 1) + 1);
    v2.alg_enum =
      new_Eds (i1 + 1, i2 + 1, back_closed, i1 + 1, j1, i2 + 1, j2);
    /* No iteration neccessary! */
  }
  else {
    v2.alg_mfe = 65000;
...
struct str1
back_closed (int i1, int j1, int i2, int j2)
{
  struct str1 v1, v2, v3, v4, v5, v6, v7, v7b, v7c, v7d, v7e, v7f, v7g, v8,
    v9, v10, v11, v12;
  int k;
  int k2;
  int k3;
  ...
  if (((j1 - i1) >= 2) && ((j2 - i2) >= 2)) {
    if (compl (x[i1 + 1], y[i2 + 1])) {
      ...
      v1.alg_enum =
        new_Sr (i1 + 1, i2 + 1, back_closed, i1 + 1, j1, i2 + 1, j2);
      /* No iteration neccessary! */
    }
    else {
      v1.alg_mfe = 65000;
      ...
      v2.alg_mfe =
        (tbl_closed[k][i2 + 1] +
         bl_stacking ((k) - (i1 + 1), 0, i1 + 1,
                      i2 + 1)) + bl_ent ((k) - (i1 + 1));
      v2.alg_enum =
        new_Bt (i1 + 1, i2 + 1, i1 + 1, k, i2 + 1, back_closed, k, j1,
                i2 + 1, j2);
      /* No iteration neccessary! */
      /* ------------------------- v3 = minimum(v2, v3) ------------------------ */
      if (v2.alg_mfe < v3.alg_mfe) {
      ...
      v4.alg_mfe =
        (tbl_closed[i1 + 1][k2] +
         bl_stacking (0, (k2) - (i2 + 1), i1 + 1,
                      i2 + 1)) + bl_ent ((k2) - (i2 + 1));
      v4.alg_enum =
        new_Bb (i1 + 1, i2 + 1, i1 + 1, i2 + 1, k2, back_closed, i1 + 1,
                j1, k2, j2);
      /* No iteration neccessary! */
      /* ------------------------- v5 = minimum(v4, v5) ------------------------ */
        ...
        if (compl (x[k3 + 1], y[k4 + 1])) {
          v6.alg_mfe =
            do_il_special (i1 + 1, i2 + 1, i1 + 1, k3, i2 + 1, k4,
                           tbl_closed[k3][k4]);
          v6.alg_enum =
            new_Il (i1 + 1, i2 + 1, i1 + 1, k3, i2 + 1, k4,
                    back_closed, k3, j1, k4, j2);
          /* No iteration neccessary! */
...
void
mainloop (int bflag, int hit_number, int eflag, float energy_cutoff,
          int pflag, float pvalue_cutoff, int compact_output, char *target_ac,
          char *target_sq, char *query_ac, char *query_sq, int gflag,
          int plot_format, float xi, float theta)
{
  int i1, i2;
  double v2;
  struct str1 l;
  ...
  int
    no_nil_so_far,
    iterate, hit_count, k, k1, k2, sepPos, ali_length, hit_length, t_len;

  float normalised_energy, mde, mde_ratio, pvalue;
...
/*      gx = 1; */
    ...
    if ((!eflag || v2 <= energy_cutoff)
        && (!pflag || pvalue <= pvalue_cutoff) && no_nil_so_far) {
      ...
      if (compact_output) {     /* compact output */
        printf ("%s:%d:%s:%d:%.1f:%.6f:%d:%s:%s:%s:%s:%.4f\n",
                target_ac, m, query_ac, n, v2, pvalue, gx, t1, t2, t3,
                t4, mde_ratio);
      }
      else {                    /* verbose output */
        printf ("target: %s\n", target_ac);
...
float
maximal_duplex_energy (char *seq_arg)
{
  ...
  for (i = 0; i < seq_len - 1; i++)
    mde +=
      stack_dg_ar[rc[seq_len - i - 1]][rc[seq_len - (i + 1) - 1]][seq[i + 1]]
      [seq[i]];

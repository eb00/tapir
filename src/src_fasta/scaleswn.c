...
/* $Name: fa34t25d9 $ - $Id: scaleswn.c,v 1.57 2005/09/27 15:32:58 wrp Exp $ */
...
mle_cen(struct stat_str *sptr, int n, int M, double fc,
  ...
  */
  ...
  } while (fabs((lambda - old_lambda)/lambda) > TINY);
...
zs_to_bit(double zs, int n0, int n1)
{
  ...
  return (PI_SQRT6 * z + EULER_G + log((double)(n0*n1)))/LN2 ;
}

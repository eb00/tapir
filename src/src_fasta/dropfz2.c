...
/* $Name: fa34t25d9 $ - $Id: dropfz2.c,v 1.52 2006/06/01 16:05:30 wrp Exp $ */
...
static void pre_com(const unsigned char *aa0, int n0, unsigned char *aa0v)
{
  int dnav, i;
...
static void pre_com_r(const unsigned char *aa0, int n0, unsigned char *aa0v)
{
    int dnav, i, ir;
...
/*
   ...
   and ex ey is the ending position 
*/
static int local_align(x, y, ex, ey, wgts, dnap, ld, pro, lp, f_str)
...
static int find_best(up, down, m1, m2, ld, y)
     st_ptr up, down; 
     int ld, y;
     int *m1, *m2;
{

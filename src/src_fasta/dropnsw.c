...
/* $Name: fa34t25d9 $ - $Id: dropnsw.c,v 1.33 2006/06/01 16:05:30 wrp Exp $ */
...
static char *verstr="3.41 May 2006";
...
static int align(const unsigned char *A, const unsigned char *B, int M, int N,
